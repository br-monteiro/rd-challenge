...
class CustomerSuccessBalancingTests < Minitest::Test
  ...
  def test_getBusiestCSS
    balancer = CustomerSuccessBalancing.new([], [], [])
    assert_equal 0, balancer.getBusiestCSS([])
    assert_equal 7, balancer.getBusiestCSS([{:id=>7, :score=>77, :count=>1}])
    assert_equal 7, balancer.getBusiestCSS([{:id=>7, :score=>77, :count=>1}, {:id=>1, :score=>77, :count=>0}])
    assert_equal 0, balancer.getBusiestCSS([{:id=>7, :score=>77, :count=>1}, {:id=>1, :score=>77, :count=>1}])
    assert_equal 0, balancer.getBusiestCSS([{:id=>7, :score=>77, :count=>2}, {:id=>1, :score=>77, :count=>2}])
  end
